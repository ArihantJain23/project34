...
function setup() {
  ...
  box3 = new Box(900, 510, 70, 70);
  box4 = new Box(900, 420, 70, 70);
  box5 = new Box(900, 200, 70, 70);
  box6 = new Box(900, 200, 70, 70);
  box7 = new Box(800, 200, 70, 70);
  box8 = new Box(600, 290, 70, 70);
  box9 = new Box(600, 375, 70, 70);
  box10 = new Box(600, 460, 70, 70); 
  box11 = new Box(600, 550, 70, 70);
  box12 = new Box(800, 200, 70, 70);
  box13 = new Box(800, 100, 70, 70);
  box14 = new Box(800, 200, 70, 70);
  box15 = new Box(800, 280, 70, 70);
  box16 = new Box(800, 370, 70, 70);
  box17 = new Box(800, 450, 70, 70);
  box18 = new Box(800, 540, 70, 70);
  box19 = new Box(700, 210, 70, 70);
  box20 = new Box(700, 100, 70, 70);
  box21 = new Box(700, 310, 70, 70);
  box22 = new Box(700, 400, 70, 70);
  box23 = new Box(700, 490, 70, 70);
  box24 = new Box(900, 100, 70, 70);
  box25 = new Box(900, 310, 70, 70);
